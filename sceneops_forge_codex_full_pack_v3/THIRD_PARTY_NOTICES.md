...
Dockview Core 8.2.0（MIT）的受控本地修改见 `patches/dockview-core@8.2.0.patch`：补齐 EdgeGroupView 的公开 setSize 订阅。修改四个分发 bundle，未修改版权、许可证或 Enterprise 水印；pnpm 锁文件记录该补丁，升级时以回归结果决定移除。
