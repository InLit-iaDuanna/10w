...
class MockWorkers:
    ...
    def list_workers(self, project_id):
        return self.items if project_id == "prj_home_mock" else []


def create_demo_workbench() -> OperationsWorkbench:
    ...
    return OperationsWorkbench(IntegrationCenterService(gateway, logs, MockWorkers()), logs, projects, FIXTURE_TIME)
